...
G_CVAR( g_gravity, "g_gravity", "800", CVAR_SERVERINFO, 0, qtrue, qfalse )
...
G_CVAR( pmove_fixed, "pmove_fixed", "1", CVAR_SYSTEMINFO, 0, qfalse, qfalse )
#else
#ifdef USE_MULTIVM_CLIENT
G_CVAR( pmove_fixed, "pmove_fixed", "1", CVAR_SYSTEMINFO, 0, qfalse, qfalse )
#else
G_CVAR( pmove_fixed, "pmove_fixed", "3", CVAR_SYSTEMINFO, 0, qfalse, qfalse )
#endif
#endif
...
G_CVAR( g_multigame, "multigame", "1" , CVAR_SERVERINFO | CVAR_ROM, 0, qfalse, qfalse )
...
#ifdef USE_TEAM_VARS
G_CVAR( g_flagReturn, "g_flagReturn", "30000", CVAR_ARCHIVE, 0, qfalse, qfalse )
#endif

#ifdef USE_SERVER_ROLES
G_CVAR( g_callvotable, "g_callvotable", "map_restart map rotate nextmap "
	"kick clientkick g_gametype g_unlagged g_warmup timelimit"
	"fraglimit capturelimit", CVAR_ARCHIVE, 0, qfalse, qfalse)
#endif
